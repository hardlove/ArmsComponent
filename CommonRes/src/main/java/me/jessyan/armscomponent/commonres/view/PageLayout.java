...
public class PageLayout extends FrameLayout {
    ...
    public static class Builder {
        ...
        private void setDefaultEmpty() {
            mPageLayout.mEmpty = mInflater.inflate(R.layout.public_layout_empty, mPageLayout, false);
        ...
        private void setDefaultError() {
            mPageLayout.mError = mInflater.inflate(R.layout.public_layout_error, mPageLayout, false);
        ...
        private void setDefaultLoading() {
            mPageLayout.mLoading = mInflater.inflate(R.layout.public_layout_loading, mPageLayout, false);
            ...
            if (content != null) {
                ...
                if (targetView instanceof View) {
                    ...
                    for (int i = 0; i < childCount; i++) {
                        if (oldContent == content.getChildAt(i)) {
                            index = i;
                            break;
                        }
                    }
